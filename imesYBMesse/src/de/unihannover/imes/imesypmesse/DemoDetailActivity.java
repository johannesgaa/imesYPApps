...
public class DemoDetailActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			arguments.putString(DemoDetailFragment.ARG_ITEM_ID, getIntent()
					.getStringExtra(DemoDetailFragment.ARG_ITEM_ID));
			DemoDetailFragment fragment = new DemoDetailFragment();
			fragment.setArguments(arguments);
			getSupportFragmentManager().beginTransaction()
					.add(R.id.demo_detail_container, fragment).commit();
		}
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case android.R.id.home:
			...
			NavUtils.navigateUpTo(this,
					new Intent(this, DemoListActivity.class));
			return true;
		}
